...
COLLATERAL_TOKEN_ID=$(stellar contract id asset --asset native --network "$NETWORK" 2>&1 | tail -1)
...
DEBT_TOKEN_ID=$(stellar contract deploy \
...
echo ""
echo "  Users deposit native XLM as collateral."
echo "  No faucet needed — Freighter testnet wallets already have XLM."
echo ""
